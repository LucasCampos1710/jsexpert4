...
import Attendee from '../entites/attendee.js'
import Room from '../entites/room.js'
...
export default class RoomsController {
    ...
    joinRoom(socket, { user, room }) {
        ...
        this.#replyWithActiveUser(socket, updatedRoom.users)
    }

    #replyWithActiveUser(socket, users) {
